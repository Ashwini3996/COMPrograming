...
DECLARE_INTERFACE_(ISum, IUnknown)// this line analogus to class ISum: public IUnknown
{
	//IUnknown method
	//HRESULT __stdcall QureyInterface(REFIID,void**)//c++ line
...
};//internaly struct aahe by default struct madhle members public astat

#undef INTERFACE
#define INTERFACE ISubtract
DECLARE_INTERFACE_(ISubtract, IUnknown)// this line analogus to class ISubtract: public IUnknown
{
	//IUnknown method
	//HRESULT __stdcall QureyInterface(REFIID,void**)//c++ line
	STDMETHOD(QureyInterface)(THIS_ REFIID, void**) PURE;
